...
function LoadConfig() {
	...
	*/
	...
	Config.HealMP = 10; // Go to a healer if under designated percent of mana.
	...
	Config.RejuvBuffer = 1; // Number of rejuvenation potions to keep in inventory.
	...
	Config.StashGold = 3000; // Minimum amount of gold to stash.
	...
	// Gambling config
	Config.Gamble = true;
	Config.GambleGoldStart = 25000000;
	...
	//Config.Recipes.push([Recipe.Blood.Boots, "light plated Boots"]); 		// Craft light plated boots       
	...
	Config.Recipes.push([Recipe.Caster.Boots, "Wyrmhide Boots"]); 		// Craft Wyrmhide Boots Caster
	...
	//Config.Recipes.push([Recipe.Socket.Armor, "Archon Plate", Roll.NonEth]); 		// Socket non eth Archon Plate
	Config.Recipes.push([Recipe.Socket.Armor, "Dusk Shroud", Roll.Eth]); 			// Socket ethereal dusk shroud
	//Config.Recipes.push([Recipe.Socket.Armor, "Dusk Shroud", Roll.NonEth]); 		// Socket non ETH dusk shroud
	//Config.Recipes.push([Recipe.Socket.Shield, "Monarch", Roll.NonEth]); 			// Socket Monarch
	Config.Recipes.push([Recipe.Socket.Shield, "Vortex Shield", Roll.Eth]); 		// Socket Vortex eth
	Config.Recipes.push([Recipe.Socket.Shield, "Sacred Targe", Roll.Eth]); 			// Socket Sacred Targe eth
	Config.Recipes.push([Recipe.Socket.Shield, "Sacred Rondache", Roll.Eth]); 		// Socket Sacred Rondache eth
	Config.Recipes.push([Recipe.Socket.Shield, "Zakarum Shield", Roll.Eth]); 		// Socket Zakarum Shield eth
	Config.Recipes.push([Recipe.Socket.Weapon, "Colossus Blade", Roll.Eth]); 		// Socket Colossus Blade eth
	Config.Recipes.push([Recipe.Socket.Weapon, "War Pike", Roll.Eth]); 				// Socket WarPike eth
	//Config.Recipes.push([Recipe.Socket.Weapon, "Berserker Axe", Roll.Eth]); 		// Socket Berserker Axe eth
	...
	//Config.Runewords.push([Runeword.Insight, "Colossus Voulge"]); // Make insight cv
	//Config.Runewords.push([Runeword.Insight, "Cryptic Axe"]); // Make Insight Cryptic Axe
	Config.Runewords.push([Runeword.Insight, "Thresher"]); // Make Insight Tresher
	Config.Runewords.push([Runeword.Insight, "Giant Thresher"]); // Make Insight Giant Tresher
	Config.Runewords.push([Runeword.Insight, "Bill"]); // Make Insight Tresher
	...
	Config.Runewords.push([Runeword.Spirit, "Sacred Rondache"]); // Make Sacred Rondache
	Config.Runewords.push([Runeword.Spirit, "Zakarum Shield"]); // Make Zakarum Shield
	Config.Runewords.push([Runeword.Spirit, "Kurast Shield"]); // Make Kurast Shield

	//Config.KeepRunewords.push("[type] == shield || [type] == auricshields # [fcr] >= 35");
	Config.KeepRunewords.push("[type] == auricshields # [fcr] >= 25");
	Config.KeepRunewords.push("[name] == monarch # [fcr] >= 25");
	
	//Config.Runewords.push([Runeword.CallToArms, "Crystal Sword"]); // make Call To Arms  CS
	//Config.Runewords.push([Runeword.CallToArms, "Flail"]);         // make Call To Arms FLAIL
	
	//Config.KeepRunewords.push("[name] == flail || [name] == CrystalSword && [Flag] != ethereal # [plusskillbattleorders] >= 1");
	
	//Config.Runewords.push([Runeword.HeartoftheOak, "Flail"]);         // make HOTO FLAIL
	
	Config.KeepRunewords.push("[name] == flail && [Flag] != ethereal # [fireresist] >= 1");
	...
	Config.MinGameTime = 86400; // Min game time in seconds. Bot will TP to town and stay in game if the run is completed before.
	...
	Config.SoJWaitTime = 10; // Time in minutes to wait for another SoJ sale before leaving game. 0 = disabled
